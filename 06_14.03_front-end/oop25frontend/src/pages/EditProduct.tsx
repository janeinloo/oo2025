...
function EditProduct() {
  ...
  const {productId} = useParams(); // App.tsx: <route path="/manage/edit-product/:productId"
  ...
  const editProduct = () => {
    const modifiedProduct = {
      ...
      price: Number(priceRef.current?.value), // kui on numbriline vaartus, siis peaksin Number() umber panema
        ...
        "Content-Type": "application/json"
          ...
          .then(json => {
            if (json.message && json.timestamp && json.status) {
              ...
              navigate("/manage/products"); // redirectib tagasi manage products lehele
            }
          });
  }
